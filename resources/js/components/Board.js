            ...
            <div id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" className="app-default">
                ...
                <div className="d-flex flex-column flex-root app-root" id="kt_app_root">
                    ...
                    <div className="app-page flex-column flex-column-fluid" id="kt_app_page">
                            {/*begin::Main*/}
                            <div className="app-main flex-column flex-row-fluid" style={{backgroundColor:"#8241B8"}} id="kt_app_main">
                                    ...
                                    <div id="kt_app_content" className="app-content flex-column-fluid">
                                        ...
                                        <div id="kt_app_content_container" className="app-container container-xxl">
                                                ...
                                                <div className="card-body pt-9 pb-0">
                                                    ...
                                                    <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold ">
                                                        ...
                                                        <li className="nav-item mt-2">
                                                            <Link className="nav-link text-active-primary text-primary ms-0 me-10 py-5" to="/#">Project Management</Link>
                                                        </li>
                                                        {/*end::Nav item*/}
                                                        {/*begin::Nav item*/}
                                                        <li className="nav-item mt-2">
                                                            <Link className="nav-link text-active-primary text-decoration-none text-primary ms-0 me-10 py-5 active" to="/#">Templates</Link>
                                                        </li>
                                                        {/*end::Nav item*/}
                                                        {/*begin::Nav item*/}
                                                        <li className="nav-item mt-2">
                                                            <Link className="nav-link text-active-primary ms-0 me-10 py-5" to="/#">Public</Link>
                                                        </li>
                                                        {/*end::Nav item*/}
                                                        {/*begin::Nav item*/}
                                                        <li className="nav-item mt-2">
                                                            <Link className="nav-link text-active-primary text-primary ms-0 me-10 py-5" to="/Board">Board</Link>
                                                        </li>
                                                        {/*end::Nav item*/}
                                                        {/*begin::Nav item*/}
                                                        <li className="nav-item mt-2">
                                                            <Link className="nav-link text-active-primary text-primary ms-0 me-10 py-5" to="/Table">Table</Link>
                                                        </li>
                                                        {/*end::Nav item*/}
                                                        {/*begin::Nav item*/}
                                                        <li className="nav-item mt-2">
                                                            <Link className="nav-link text-active-primary text-primary ms-0 me-10 py-5" to="/Activity">Activity</Link>
                                                        </li>
                                                        {/*end::Nav item*/}
                                                    </ul>
                                                    {/*begin::Navs*/}
                                            ...
                                            <div className="d-flex flex-wrap flex-stack mb-6">
                                                {/*begin::Heading*/}
                                                {/* board Functions */}
                                                <h3 className="fw-bold my-2">Project Management
                                                ...
                                                <div className="d-flex flex-wrap my-2">
                                                    <div className="me-4">
                                                        {/*begin::Select*/}
                                                        <select name="status" data-control="select2" data-hide-search="true" className="form-select form-select-sm bg-body border-body w-125px">
                                            ...
                                            <div className="row g-6 g-xl-9">
                                                ...
                                                <div className="col-md-6 col-xl-4">
                                                    {/*begin::Card*/}
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        {/*begin::Card header*/}
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="d-flex flex-wrap mb-5">
                                                                ...
                                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                                                    <div className="fs-6 text-gray-800 fw-bold">Jun 24, 2022</div>
                                                    ...
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="d-flex flex-wrap mb-5">
                                                                {/*begin::Due*/}
                                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                                                    <div className="fs-6 text-gray-800 fw-bold">Nov 10, 2022</div>
                                                                    <div className="fw-semibold text-gray-400">Due Date</div>
                                                                </div>
                                                                {/*end::Due*/}
                                                                {/*begin::Budget*/}
                                                    ...
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="h-4px w-100 bg-light mb-5" data-bs-toggle="tooltip" title="This project 40% completed">
                                                                <div className="bg-primary rounded h-4px" role="progressbar" style={{width:"40%"}} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            {/*end::Progress*/}
                                                            {/*begin::Users*/}
                                                            <div className="symbol-group symbol-hover">
                                                    ...
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="d-flex flex-wrap mb-5">
                                                                {/*begin::Due*/}
                                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                                                    <div className="fs-6 text-gray-800 fw-bold">Jun 20, 2022</div>
                                                                    <div className="fw-semibold text-gray-400">Due Date</div>
                                                                </div>
                                                                {/*end::Due*/}
                                                                {/*begin::Budget*/}
                                                    ...
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="d-flex flex-wrap mb-5">
                                                                {/*begin::Due*/}
                                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                                                    <div className="fs-6 text-gray-800 fw-bold">Mar 10, 2022</div>
                                                                    <div className="fw-semibold text-gray-400">Due Date</div>
                                                                </div>
                                                                {/*end::Due*/}
                                                                {/*begin::Budget*/}
                                                    ...
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="h-4px w-100 bg-light mb-5" data-bs-toggle="tooltip" title="This project 10% completed">
                                                                <div className="bg-danger rounded h-4px" role="progressbar" style={{width:"10%"}} aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            {/*end::Progress*/}
                                                            {/*begin::Users*/}
                                                            <div className="symbol-group symbol-hover">
                                                    ...
                                                    <a href="../../demo1/dist/apps/projects/project.html" className="card border-hover-primary">
                                                        ...
                                                        <div className="card-body p-9">
                                                            ...
                                                            <div className="d-flex flex-wrap mb-5">
                                                                {/*begin::Due*/}
                                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                                                    <div className="fs-6 text-gray-800 fw-bold">Feb 21, 2022</div>
                                                                    <div className="fw-semibold text-gray-400">Due Date</div>
                                                                </div>
                                                                {/*end::Due*/}
                                                                {/*begin::Budget*/}
                                                                            ...
                                                                            <div className="w-100">
                                                                                ...
                                                                                <div className="fv-row mb-15" data-kt-buttons="true">
                                                                                    ...
                                                                                    <label className="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 active">
                                                                                        {/*begin::Input*/}
                                                                                        <input className="btn-check" type="radio" checked="checked" name="project_type" value="1" />
                                                                                        {/*end::Input*/}
                                                                                        {/*begin::Label*/}
                                                                                    ...
                                                                                    <div className="d-flex flex-stack">
                                                                                        ...
                                                                                        <div className="d-flex">
                                                                                            ...
                                                                                            <label className="form-check form-check-custom form-check-solid">
                                                                                                {/*begin::Input*/}
                                                                                                <input className="form-check-input h-20px w-20px" type="checkbox" value="phone" checked="checked" name="settings_notifications[]" />
                                                                                                {/*end::Input*/}
                                                                                                {/*begin::Label*/}
                                                                            ...
                                                                            <div className="w-100">
                                                                                ...
                                                                                <div className="fv-row mb-8">
                                                                                    ...
                                                                                    <div className="position-relative w-lg-250px" id="kt_modal_create_project_budget_setup" data-kt-dialer="true" data-kt-dialer-min="50" data-kt-dialer-max="50000" data-kt-dialer-step="100" data-kt-dialer-prefix="$" data-kt-dialer-decimals="2">
                                                                                        ...
                                                                                        {/*begin::Input control*/}
                                                                                        <input type="text" className="form-control form-control-solid border-0 ps-12" data-kt-dialer-control="input" placeholder="Amount" name="budget_setup" readonly="readonly" value="$50" />
                                                                                        {/*end::Input control*/}
                                                                                        ...
                                                                                        <div className="col-md-6 col-lg-12 col-xxl-6">
                                                                                            ...
                                                                                            <label className="btn btn-outline btn-outline-dashed btn-active-light-primary active d-flex text-start p-6" data-kt-button="true">
                                                                                                ...
                                                                                                <span className="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                                                    <input className="form-check-input" type="radio" name="budget_usage" value="1" checked="checked" />
                                                                                                </span>
                                                                                                {/*end::Radio*/}
                                                                                                {/*begin::Info*/}
                                                                                                <span className="ms-5">
                                                                                ...
                                                                                <div className="fv-row mb-15">
                                                                                    ...
                                                                                    <div className="d-flex flex-stack">
                                                                                        ...
                                                                                        <label className="form-check form-switch form-check-custom form-check-solid">
                                                                                            <input className="form-check-input" type="checkbox" value="1" name="budget_allow" checked="checked" />
                                                                            ...
                                                                            <div className="w-100">
                                                                                ...
                                                                                <div className="fv-row mb-8">
                                                                                    ...
                                                                                    <div className="d-flex flex-stack">
                                                                                        ...
                                                                                        {/*begin::Switch*/}
                                                                                        <label className="form-check form-switch form-check-custom form-check-solid">
                                                                                            <input className="form-check-input" type="checkbox" value="1" name="target_allow" checked="checked" />
                                                                                            <span className="form-check-label fw-semibold text-muted">Allowed</span>
                                                                                        </label>
                                                                                        {/*end::Switch*/}
                                                                                    </div>
                                                                                ...
                                                                                <div className="fv-row mb-15">
                                                                                    ...
                                                                                    <div className="d-flex flex-stack">
                                                                                        ...
                                                                                        <div className="d-flex">
                                                                                            ...
                                                                                            <label className="form-check form-check-custom form-check-solid">
                                                                                                {/*begin::Input*/}
                                                                                                <input className="form-check-input h-20px w-20px" type="checkbox" value="phone" checked="checked" name="target_notifications[]" />
                                                                                                {/*end::Input*/}
                                                                                                {/*begin::Label*/}
                                                                                                <span className="form-check-label fw-semibold">Phone</span>
                                                                                                {/*end::Label*/}
                                ...
                                <div className="mb-0">
                                    ...
                                    <div className="mb-7">
                                        <div className="d-flex flex-stack">
                                            ...
                                            <a href="https://themeforest.net/licenses/standard" className="fw-semibold" target="_blank">License FAQs</a>
                                        </div>
                                    </div>
                                    {/*end::Heading*/}
                                    {/*begin::License*/}
                                        ...
                                        <div className="d-flex flex-stack">
                                            <div className="d-flex flex-column">
                                                <div className="d-flex align-items-center mb-1">
                                                    <div className="fs-6 fw-semibold text-gray-800 fw-semibold mb-0 me-1">Regular License</div>
                                                    <i className="text-gray-400 fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="popover" data-bs-custom-className="popover-inverse" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Use, by you or one client in a single end product which end users are not charged for"></i>
                                                </div>
                                    ...
                                    <div className="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
                                        <div className="d-flex flex-stack">
                                            <div className="d-flex flex-column">
                                                <div className="d-flex align-items-center mb-1">
                                                    <div className="fs-6 fw-semibold text-gray-800 fw-semibold mb-0 me-1">Extended License</div>
                                                    <i className="text-gray-400 fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="popover" data-bs-custom-className="popover-inverse" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Use, by you or one client, in a single end product which end users can be charged for."></i>
                                                </div>
                                    ...
                                    <div className="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
                                        <div className="d-flex flex-stack">
                                            <div className="d-flex flex-column">
                                                <div className="d-flex align-items-center mb-1">
                                                    <div className="fs-6 fw-semibold text-gray-800 fw-semibold mb-0 me-1">Custom License</div>
                                                </div>
                                                <div className="fs-7 text-muted">Reach us for custom license offers.</div>
                                            </div>
                                            <div className="text-nowrap">
                                                <a href="https://devs.keenthemes.com" className="btn btn-sm btn-success" target="_blank">Contact Us</a>
                                            </div>
                                        </div>
                                    </div>
                                    {/*end::License*/}
                                    {/*begin::Purchase*/}
                                    <a href="https://1.envato.market/EA4JP" className="btn btn-primary fw-bold mb-15 w-100">Buy Now</a>
                                    {/*end::Purchase*/}
                                    {/*begin::Demos*/}
                                    <div className="mb-0">
                                        ...
                                        <div className="row g-5">
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="overlay overflow-hidden position-relative border border-4 border-success rounded">
                                                    ...
                                                    <div className="overlay-layer bg-dark bg-opacity-10">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo1" className="btn btn-sm btn-success shadow">Metronic Original</a>
                                                    </div>
                                                </div>
                                                {/*end::Demo*/}
                                            </div>
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                    <div className="overlay-wrapper">
                                                        <img src="assets/media/demos/demo21.png" alt="demo" className="w-100" />
                                                    </div>
                                                    <div className="overlay-layer bg-dark bg-opacity-10">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo21" className="btn btn-sm btn-success shadow">Demo 21</a>
                                                    </div>
                                                </div>
                                                {/*end::Demo*/}
                                            </div>
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                    <div className="overlay-wrapper">
                                                        <img src="assets/media/demos/demo22.png" alt="demo" className="w-100" />
                                                    </div>
                                                    <div className="overlay-layer bg-dark bg-opacity-10">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo22" className="btn btn-sm btn-success shadow">Demo 22</a>
                                                    </div>
                                                </div>
                                                {/*end::Demo*/}
                                            </div>
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                    <div className="overlay-wrapper">
                                                        <img src="assets/media/demos/demo23.png" alt="demo" className="w-100" />
                                                    </div>
                                                    <div className="overlay-layer bg-dark bg-opacity-10">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo23" className="btn btn-sm btn-success shadow">Demo 23</a>
                                                    </div>
                                                </div>
                                                {/*end::Demo*/}
                                            </div>
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                    <div className="overlay-wrapper">
                                                        <img src="assets/media/demos/demo24.png" alt="demo" className="w-100" />
                                                    </div>
                                                    <div className="overlay-layer bg-dark bg-opacity-10">
                                                        <a href="https://preview.keenthemes.com/metronic8/demo24" className="btn btn-sm btn-success shadow">Demo 24</a>
                                                    </div>
                                                </div>
                                                {/*end::Demo*/}
                                            </div>
                        ...
                        <div className="card-body" id="kt_help_body">
                            ...
                            <div id="kt_help_scroll" className="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
                                ...
                                <div className="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
                                    {/*begin::Heading*/}
                                    <h2 className="fw-bold mb-5">Support at
                                        <a href="https://devs.keenthemes.com" className="">devs.keenthemes.com</a></h2>
                                    {/*end::Heading*/}
                                    {/*begin::Description*/}
                                ...
                                <div className="d-flex align-items-center mb-7">
                                    ...
                                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                                        ...
                                        <div className="d-flex flex-column me-2 me-lg-5">
                                            {/*begin::Title*/}
                                            <a href="https://preview.keenthemes.com/html/metronic/docs" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation & Videos</a>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="text-muted fw-semibold fs-7 fs-lg-6">From guides and video tutorials, to live demos and code examples to get started.</div>
                                            {/*end::Description*/}
                                        </div>
                                        {/*end::Wrapper*/}
                                        {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
                                ...
                                <div className="d-flex align-items-center mb-7">
                                    ...
                                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                                        ...
                                        <div className="d-flex flex-column me-2 me-lg-5">
                                            {/*begin::Title*/}
                                            <a href="https://preview.keenthemes.com/html/metronic/docs//base/utilities" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Plugins & Components</a>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="text-muted fw-semibold fs-7 fs-lg-6">Check out our 300+ in-house components and customized 3rd-party plugins.</div>
                                            {/*end::Description*/}
                                        </div>
                                        {/*end::Wrapper*/}
                                        {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
                                ...
                                <div className="d-flex align-items-center mb-7">
                                    ...
                                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                                        ...
                                        <div className="d-flex flex-column me-2 me-lg-5">
                                            {/*begin::Title*/}
                                            <a href="https://preview.keenthemes.com/metronic8/layout-builder.html" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Layout Builder</a>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="text-muted fw-semibold fs-7 fs-lg-6">Build your layout, preview it and export the HTML for server side integration.</div>
                                            {/*end::Description*/}
                                        </div>
                                        {/*end::Wrapper*/}
                                        {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
                                ...
                                <div className="d-flex align-items-center mb-7">
                                    ...
                                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                                        ...
                                        <div className="d-flex flex-column me-2 me-lg-5">
                                            {/*begin::Title*/}
                                            <a href="https://devs.keenthemes.com/metronic" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Metronic Downloads</a>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="text-muted fw-semibold fs-7 fs-lg-6">Download your prefered framework and demo with one click.</div>
                                            {/*end::Description*/}
                                        </div>
                                        {/*end::Wrapper*/}
                                        {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
                                ...
                                <div className="d-flex align-items-center mb-7">
                                    ...
                                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                                        ...
                                        <div className="d-flex flex-column me-2 me-lg-5">
                                            {/*begin::Title*/}
                                            <a href="https://preview.keenthemes.com/html/metronic/docs/getting-started/changelog" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">What's New ?</a>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="text-muted fw-semibold fs-7 fs-lg-6">Latest features and improvements added with our users feedback in mind.</div>
                                            {/*end::Description*/}
                                        </div>
                                        {/*end::Wrapper*/}
                                        {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
                ...
                <div className="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0 transform-90 mt-5 mt-lg-20 gap-2">
                    ...
                    <button id="kt_engage_demos_toggle" className="engage-demos-toggle engage-btn btn shadow-sm fs-6 px-4 rounded-top-0" title="Check out 24 more demos" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
                        <span id="kt_engage_demos_label">Demos</span>
                    </button>
                    {/*end::Demos drawer toggle*/}
                    {/*begin::Help drawer toggle*/}
                    <button id="kt_help_toggle" className="engage-help-toggle btn engage-btn shadow-sm px-5 rounded-top-0" title="Learn & Get Inspired" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">Help</button>
