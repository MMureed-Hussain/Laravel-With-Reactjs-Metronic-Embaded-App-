                        ...
                        <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                            ...
                            <div className="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <div className="m-0">
                                    ...
                                    {/*end::Menu toggle*/}
                                    {/*begin::Menu 1*/}
                                    <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_633f09c1a145e">
                                        {/*begin::Header*/}
                                        ...
                                        <div className="px-7 py-5">
                                            ...
                                            <div className="mb-10">
                                                ...
                                                {/*begin::Input*/}
                                                <div>
                                                    <select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_633f09c1a145e" data-allow-clear="true">
                                                        <option></option>
                                ...
                                <div className="card-header card-header-stretch">
                                    ...
                                    <div className="card-toolbar m-0">
                                        ...
                                        <ul className="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bold" role="tablist">
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <a id="kt_activity_year_tab" className="nav-link justify-content-center text-active-gray-800 text-hover-gray-800" data-bs-toggle="tab" role="tab" href="#kt_activity_year">2022</a>
                                            </li>
                                        </ul>
                                        {/*end::Tab nav*/}
                                    </div>
